...
table_name1 = os.environ.get("TABLE_NAME1")
table_name2 = os.environ.get("TABLE_NAME2")
table_name3 = os.environ.get("TABLE_NAME3")
DOMAIN = "https://jesusmaeso-sandbox.pipedrive.com/"
DOMAIN_DEAL = "https://developers.pipedrive.com/docs/api/v1/Deals"
FOLDER_PATH = "./"
FOLDER_PATH_BRONZE = "./bronze/"
FOLDER_PATH_SILVER = "./silver/"
DATABASE = "Pipedrive_persons"


if not api_token or not client_id or not client_secret:
    raise ValueError("Una o más variables de entorno no se cargaron correctamente.")

client = Client(client_id, client_secret, DOMAIN)
...
def export_pipedrive_data(client):
    """
...
connection_string = (
    ...
    f"Server= {server};"  # Cambia a tu servidor
